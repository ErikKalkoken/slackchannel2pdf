...
class TestExporterTransformText(unittest.TestCase):
    ...
    def test_transform_text_user(self):
        self.assertEqual(
            self.exporter._transform_text("<@U62345678>", True), "<b>@Janet Hakuli</b>"
        )
        self.assertEqual(
    ...
    def test_transform_text_channel(self):
        self.assertEqual(
            self.exporter._transform_text("<#C72345678>", True), "<b>#tokio</b>"
        )
        self.assertEqual(
    ...
    def test_transform_text_special(self):
        self.assertEqual(
            self.exporter._transform_text("<!everyone>", True), "<b>@everyone</b>"
        )
        self.assertEqual(self.exporter._transform_text("<!here>", True), "<b>@here</b>")
        self.assertEqual(
            self.exporter._transform_text("<!channel>", True), "<b>@channel</b>"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            self.exporter._transform_text("<!xyz>", True), "<b>@special_xyz</b>"
        )

    def test_transform_text_url(self):
        self.assertEqual(
            self.exporter._transform_text("<https://www.google.com|Google>", True),
            '<a href="https://www.google.com">Google</a>',
        )
        self.assertEqual(
            self.exporter._transform_text("<https://www.google.com>", True),
            '<a href="https://www.google.com">https://www.google.com</a>',
        )

    def test_transform_text_formatting(self):
        self.assertEqual(self.exporter._transform_text("*bold*", True), "<b>bold</b>")
        self.assertEqual(
            self.exporter._transform_text("_italic_", True), "<i>italic</i>"
        )
        self.assertEqual(
            self.exporter._transform_text("text *bold* text _italic_ text", True),
    ...
    def test_transform_text_general(self):
        self.assertEqual(
            self.exporter._transform_text("some *text* <@U62345678> more text", True),
